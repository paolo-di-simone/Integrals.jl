...
L'integrale di volume si ottiene facilmente grazie al Teorema della Divergenza; questo permette di calcolare un integrale di volume da un integrale di superficie.
